...
public class LedgerApi {
    ...
    CompletableFuture<Result> exerciseAndGetResult(
        ...
        return exerciseAndGetResult(contractId, choice, commandId, List.of(), appProviderParty);
    }
    ...
    CompletableFuture<Result> exerciseAndGetResult(
        ...
        return exerciseAndGetResult(contractId, choice, commandId, disclosedContracts, appProviderParty);
    }

    /** Exercise a choice acting as the given party (for party-scoped visibility). */
    @WithSpan
    public <T extends Template, Result, C extends Choice<T, Result>>
    CompletableFuture<Result> exerciseAndGetResult(
            ContractId<T> contractId,
    ...
    public CompletableFuture<CommandSubmissionServiceOuterClass.SubmitResponse> submitCommands(
        ...
        return submitCommands(cmds, commandId, List.of(), appProviderParty);
    }
    ...
    public CompletableFuture<CommandSubmissionServiceOuterClass.SubmitResponse> submitCommands(
        ...
        return submitCommands(cmds, commandId, disclosedContracts, appProviderParty);
    }
